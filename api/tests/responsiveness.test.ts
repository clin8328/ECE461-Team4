  ...
  data: [
    {
      ...
      labels_url:
        "https://api.github.com/repos/JDCambridge/test/issues/2/labels{/name}",
      comments_url:
        "https://api.github.com/repos/JDCambridge/test/issues/2/comments",
      events_url:
        "https://api.github.com/repos/JDCambridge/test/issues/2/events",
      ...
      reactions: [Object],
      timeline_url:
        "https://api.github.com/repos/JDCambridge/test/issues/2/timeline",
    ...
    },
    {
      ...
      repository_url: "https://api.github.com/repos/JDCambridge/test",
      labels_url:
        "https://api.github.com/repos/JDCambridge/test/issues/1/labels{/name}",
      comments_url:
        "https://api.github.com/repos/JDCambridge/test/issues/1/comments",
      events_url:
        "https://api.github.com/repos/JDCambridge/test/issues/1/events",
      ...
      reactions: [Object],
      timeline_url:
        "https://api.github.com/repos/JDCambridge/test/issues/1/timeline",
      performed_via_github_app: null,
      state_reason: "completed",
    },
  ],
  ...
  describe("getCompletedIssues", () => {
    ...
    it("should error on bad data correctly", async () => {
      mockRequest.mockImplementation(() =>
        Promise.reject(new Error("bad call"))
      );
      const responsiveness = new Responsiveness(url);
      await responsiveness.getGitHubRepoUrl(url);
