...
const responsiveness_1 = require("../src/responsiveness");
...
//sample url.
let url = "https://github.com/JDCambridge/test";
describe("Responsiveness class", () => {
    ...
    describe("getCompletedIssues", () => {
        ...
        it("should fetch completed issues correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            mockRequest = jest.fn(() => {
                return Promise.resolve(mockJson);
            });
            const responsiveness = new responsiveness_1.Responsiveness(url);
            yield responsiveness.getGitHubRepoUrl(url);
            let completedIssues = yield responsiveness.getCompletedIssues(url);
        ...
        it("should error on bad data correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            mockRequest.mockImplementation(() => Promise.reject(new Error("bad call")));
            const responsiveness = new responsiveness_1.Responsiveness(url);
            yield responsiveness.getGitHubRepoUrl(url);
            const asyncCall = () => responsiveness.getCompletedIssues(url);
            yield expect(asyncCall).rejects.toThrow();
        }));
    });
    describe("numCollaborators", () => {
        it("should return a score from a URL that is in range", () => __awaiter(void 0, void 0, void 0, function* () {
            mockRequest = jest.fn(() => {
                return Promise.resolve(mockJson);
            });
            let responsiveness = new responsiveness_1.Responsiveness(url);
            yield responsiveness.getGitHubRepoUrl(url);
            const score = yield responsiveness.numCollaborators();
            console.log(score);
            let scoreInRange = score <= 1 && score >= 0;
            expect(scoreInRange).toBe(true);
        }));
        it("should return correctly error out from a bad api call", () => __awaiter(void 0, void 0, void 0, function* () {
