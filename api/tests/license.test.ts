...
describe("License Class", () => {
  ...
  it("Testing fail/success conditions on evaluate license", async () => {
    ...
    readFileSpy.mockReturnValue(
      "##Description: Testing mock feature ## License: This is under the Apache-2.0 and MIT license"
    );
    ...
    readFileSpy.mockReturnValue(
      "##Description: Testing mock feature ## License: This is under the ecl-2.0 license"
    );
